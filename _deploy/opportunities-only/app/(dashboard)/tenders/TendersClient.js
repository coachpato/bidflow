  ...
  return (
    <div className="space-y-6">
      <Header
        title="Tenders"
        eyebrow="Pipeline"
        primaryAction={{ href: '/tenders/new', label: 'New tender' }}
        meta={[
      ...
      <div className="app-page space-y-6">
        ...
        {loading ? (
          ...
          <section className="app-surface rounded-[24px] px-6 py-16 text-center">
            <p className="text-sm font-semibold text-slate-800">No tenders found.</p>
              ...
              <table className="w-full text-sm">
                <thead className="border-b border-slate-200 bg-[rgba(248,246,242,0.95)]">
                  <tr className="text-left">
                    <th className="px-5 py-4 font-semibold text-slate-500">Tender</th>
