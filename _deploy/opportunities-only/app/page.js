          ...
          <div className="space-y-6">
            ...
            <div className="max-w-4xl space-y-5">
              ...
              <p className="max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                Keep tenders, contracts, documents, and ownership in one calm workspace built for disciplined follow-through.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <SignalCard label="Tenders" value="Track the pipeline" />
              <SignalCard label="Contracts" value="Keep delivery visible" />
              <SignalCard label="Ownership" value="See who holds the work" />
            </div>
          </div>
            ...
            <section className="app-surface relative overflow-hidden rounded-[32px] border-white/55 bg-[rgba(255,255,255,0.78)] p-5 sm:p-6">
              ...
              <div className="relative space-y-5">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <PanelStat label="Due soon" value="3 tenders" tone="text-amber-700" />
                  <PanelStat label="Assigned" value="5 matters" tone="text-slate-950" />
                  <PanelStat label="Contracts" value="2 renewals" tone="text-emerald-700" />
                ...
                <div className="space-y-3 rounded-[26px] border border-slate-200/80 bg-white/88 p-4">
                  ...
                  />
                  <WorkspaceRow
                    title="Facilities advisory contract"
                    meta="Contract"
                    status="Renews soon"
                  />
                  <WorkspaceRow
