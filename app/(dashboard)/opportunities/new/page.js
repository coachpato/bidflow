          ...
          <section className="app-surface rounded-[30px] p-5 sm:p-6">
            <div className="border-b border-slate-100 pb-5">
              ...
              <p className="mt-2 text-sm leading-7 text-slate-500">
                Capture the signal before it becomes bid work. Once the team decides to pursue it, you can convert it straight into a live pursuit.
              </p>
            </div>
          ...
          <aside className="app-surface rounded-[30px] p-5 sm:p-6">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="rounded-[24px] bg-slate-50 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Once the team decides to bid, the pursuit record can inherit the dates, notes, and uploaded pack automatically.
                </p>
              </div>
            </div>
          </aside>
