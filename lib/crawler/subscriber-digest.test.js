...
describe('subscriber digest delivery', () => {
  ...
  it('sends a personalized digest email per subscriber with an unsubscribe link', async () => {
    ...
    expect(mockSendEmail.mock.calls[0][0].html).toContain('<th style="padding:12px;text-align:left;border-bottom:2px solid #e2e8f0;">Tender</th>')
    expect(mockSendEmail.mock.calls[0][0].html).toContain('<th style="padding:12px;text-align:left;border-bottom:2px solid #e2e8f0;">Category</th>')
    expect(mockSendEmail.mock.calls[0][0].html).toContain('<th style="padding:12px;text-align:left;border-bottom:2px solid #e2e8f0;">Deadline</th>')
