...
/**
 * Emits crawler events with a stable envelope while preserving the existing logger implementation.
 */
export function logCrawlerEvent({
  ...
  if (level === LOG_LEVELS.ERROR) {
    logError(message, error || message, context)
    return
  }
