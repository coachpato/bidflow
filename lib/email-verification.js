    ...
    <div style="margin:0;background:#f4efe6;padding:32px 0;">
      <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e6dfd0;border-radius:24px;overflow:hidden;font-family:Arial,sans-serif;color:#0f172a;">
        ...
        <div style="padding:32px;">
          ...
          <p style="margin:0 0 16px;font-size:15px;line-height:1.7;">Please confirm this email address to activate your Bid360 account and open your workspace.</p>
          <p style="margin:0 0 24px;font-size:15px;line-height:1.7;">This verification link expires in 24 hours.</p>
          <a href="${verificationUrl}" style="display:inline-block;padding:14px 22px;border-radius:999px;background:#0f766e;color:#ffffff;text-decoration:none;font-weight:700;">
            Verify email
          </a>
          ...
          <p style="margin:8px 0 0;font-size:13px;line-height:1.7;color:#155e75;word-break:break-all;">${verificationUrl}</p>
        </div>
      </div>
    </div>
  `
