...
export async function notifyContractAssignees({
  ...
  <p>${escapeHtml(actorName)} allocated an appointment to you in Bid360.</p>
...
${contractUrl ? `<p><a href="${contractUrl}">Open this appointment in Bid360</a></p>` : ''}
          </div>
        `,
        text: [
          `Hello ${recipient.name || recipient.email},`,
          '',
    `${actorName} allocated an appointment to you in Bid360.`,
