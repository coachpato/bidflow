...
export const OPPORTUNITY_STATUSES = ['New', 'Liked', 'Disliked', 'Pursued']
export const ACTIVE_OPPORTUNITY_STATUSES = ['New', 'Liked']
...
export function getOpportunityStatusOptions(includeConverted = false) {
  return includeConverted
    ...
    : OPPORTUNITY_STATUSES.filter(status => status !== 'Pursued')
}
