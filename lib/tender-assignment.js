...
export async function notifyTenderAssignees({
  ...
  const intro = `${escapeHtml(actorName)} assigned you to a tender in Bid360.`
    ...
    ? `<p><a href="${tenderUrl}">Open this tender in Bid360</a></p>`
        : ''
      ...
      return sendEmail({
        ...
        text: [
          ...
          '',
    `${actorName} assigned you to a tender in Bid360.`,
          `Tender: ${tender.title}`,
