...
export class NotificationService {
  ...
  static renderEmailTemplate(templateName, variables, actionLink) {
    const { organizationName = 'BidFlow', recipientName = 'Team Member', message = '' } = variables
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            ${actionButton}
            <div class="footer">
              <p>This is an automated message from BidFlow. Please do not reply to this email.</p>
            </div>
          </div>
        </body>
      </html>
